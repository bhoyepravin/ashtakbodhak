...
const ServicesPage = () => {
  ...
  return (
    <div className="min-h-screen pt-45 bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
              {categoryServices.map((service, index) => (
                <motion.div
                  ...
                  className="bg-gray-50 rounded-xl p-4 sm:p-6  transition-all duration-300"
                >
                  <div className="mb-4">
                    <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-[#235ab0] mb-2 lg:mb-3">
                      {service.title}
                    </h3>
                  ...
                  <button
                    ...
                    className="flex items-center font-medium text-sm sm:text-base mb-3 lg:mb-4 text-[#235ab0] hover:text-[#fb7e04] transition-colors duration-300"
                  >
                    Show Details
                    <svg
                  ...
                  {service.deliveryMethod && (
                    <div className="mt-4 p-3 rounded-lg bg-white/50 border border-white/30">
                      <p className="text-xs sm:text-sm font-semibold text-[#235ab0] mb-1">
                        Delivery Method:
                      </p>
