...
import networkDataSecurityData from "../../Constant/Services/networkDataSecurityData";
    ...
    <div className="min-h-screen pt-30 bg-white">
      ...
      <section className="relative py-20 bg-gradient-to-br from-[#2359B0] via-[#184E43] to-[#1F5453] overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            >
              {networkDataSecurityData.hero.title}
            </motion.h1>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              {networkDataSecurityData.hero.subtitle}
            </motion.div>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              {networkDataSecurityData.hero.description}
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <AnimatedSection className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              <h2 className="text-3xl lg:text-4xl font-bold text-[#184E43] mb-6 text-center">
                {networkDataSecurityData.overview.title}
              </h2>
              <p className="text-lg text-gray-700 mb-8 text-center leading-relaxed">
                {networkDataSecurityData.overview.description}
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-6 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <p className="text-[#2359B0] font-semibold">
                    {networkDataSecurityData.overview.duration}
                  </p>
                </div>
                <div className="text-center p-6 bg-green-50 rounded-xl border border-green-200">
                  ...
                  <p className="text-[#184E43] font-semibold">
                    {networkDataSecurityData.overview.level}
                  </p>
                </div>
                <div className="text-center p-6 bg-orange-50 rounded-xl border border-orange-200">
                  ...
                  <p className="text-[#FB7E06] font-semibold text-sm">
                    {networkDataSecurityData.overview.audience}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#184E43] mb-6">
              {networkDataSecurityData.technicalSkills.title}
            </h2>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {networkDataSecurityData.technicalSkills.skills.map(
              (skillCategory, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#184E43] mb-6">
              {networkDataSecurityData.curriculum.title}
            </h2>
          </AnimatedSection>

          <div className="max-w-6xl mx-auto space-y-8">
            {networkDataSecurityData.curriculum.modules.map((module, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-1/3">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="bg-gradient-to-r from-[#2359B0] to-[#184E43] text-white rounded-xl p-3 min-w-16 text-center">
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              {networkDataSecurityData.labEnvironment.title}
            </h2>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {networkDataSecurityData.labEnvironment.features.map(
              (feature, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#184E43] mb-6">
              {networkDataSecurityData.careerPaths.title}
            </h2>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {networkDataSecurityData.careerPaths.roles.map((role, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#184E43] mb-6">
              {networkDataSecurityData.certifications.title}
            </h2>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {networkDataSecurityData.certifications.certs.map((cert, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* <section className="py-20 bg-gradient-to-r from-[#184E43] to-[#2359B0] text-white">
        <div className="container mx-auto px-4 text-center">
          <AnimatedSection>
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">
              {networkDataSecurityData.cta.title}
            </h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
              {networkDataSecurityData.cta.description}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <Shield size={20} />
                {networkDataSecurityData.cta.button}
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              >
                <Users size={20} />
                {networkDataSecurityData.cta.secondary}
              </motion.button>
            </div>
          </AnimatedSection>
        </div>
...
export default NetworkDataSecurityPage;
