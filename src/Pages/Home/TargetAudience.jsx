    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-3xl lg:text-4xl font-bold text-[#235ab0] mb-4">
            Who We Protect
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Cybersecurity solutions tailored for every segment of society
          ...
          {audiences.map((audience, index) => (
            ...
            >
              <Link
                ...
                className="block h-full"
              >
                <div className="bg-white rounded-xl border border-[#c9e3d2] p-6 h-full transition-all duration-300 group-hover:border-[#fb7e04] group-hover:shadow-lg">
                  {/* Header */}
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-4xl">{audience.icon}</div>
                    <span className="text-sm font-bold bg-[#fb7e04] text-white px-2 py-1 rounded-full">
                      {audience.percentage}
                    </span>
                  </div>

                  {/* Title */}
                  <h3 className="text-xl font-semibold text-[#235ab0] mb-3 group-hover:text-[#13763d] transition-colors">
                    {audience.title}
                  </h3>
                  ...
                  <div className="space-y-2 mb-4">
                    {audience.challenges.slice(0, 2).map((challenge, idx) => (
                      <div key={idx} className="flex items-center space-x-2">
                        <div className="w-1.5 h-1.5 bg-[#fb7e04] rounded-full flex-shrink-0"></div>
                        <span className="text-gray-700 text-xs">
                          {challenge}
                        </span>
                      </div>
                  ...
                  {/* CTA */}
                  <div className="flex items-center justify-between pt-4 border-t border-[#c9e3d2]">
                    <span className="text-[#fb7e04] text-sm font-semibold group-hover:text-[#e57306] transition-colors">
                      Learn More
                    </span>
                    <motion.div
                      whileHover={{ x: 3 }}
                    ...
                    >
                      <svg
                        className="w-4 h-4 text-[#fb7e04] group-hover:text-[#e57306] transition-colors"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
