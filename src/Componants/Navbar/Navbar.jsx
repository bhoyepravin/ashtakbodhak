                  ...
                  <div className="space-y-0">
                    {navItems.map((item, index) => (
                      ...
                      >
                        <div className="py-1">
                          {item.submenu ? (
                            // Clickable header for submenus
                            <button
                              onClick={() => toggleMobileSubmenu(index)}
                              className={`block w-full text-base font-semibold py-2 px-2 rounded transition-all duration-300 text-left ${
                            ...
                            // Regular link for non-submenu items
                            <Link
                              to={item.path}
