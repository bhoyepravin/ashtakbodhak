...
const Footer = () => {
  ...
  const footerSections = [
    ...
    },
    {
      title: "Services",
      links: [
        { name: "Individual Training", path: "/service" },
        { name: "Technical Training", path: "/service" },
        { name: "Sector-wise Awareness", path: "/service" },
        { name: "Consulting Services", path: "/service" },
        { name: "Education & Industry", path: "/service" },
      ],
    },
  ];
          ...
          >
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <input
                ...
                required
                className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:border-[#F8810A] transition-colors text-sm"
              />
              <button
                type="submit"
                className="w-full bg-[#F8810A] text-white py-2 px-4 rounded-lg hover:bg-[#e67400] transition-colors font-medium text-sm"
              >
                Subscribe
              </button>
            </form>
