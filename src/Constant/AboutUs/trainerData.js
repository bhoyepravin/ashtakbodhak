const trainerData = {
  ...
  mission: {
    title: "Core Competencies & Expertise",
    items: [
      {
  ...
  founder: {
    name: "Cyber Security Leader & Trainer",
    message:
      "With over 22 years of rich experience across global financial institutions and leadership roles, I am passionate about sharing knowledge and building robust cybersecurity capabilities across organizations and individuals.",
    cta: "Let's build a cyber-resilient future together!",
  },
  stats: [
    {
      number: "22+",
      label: "Years Experience",
      suffix: "in cybersecurity",
    },
    {
      number: "5+",
      label: "Major Banks",
      suffix: "leadership roles",
    },
    {
      number: "1000+",
      label: "Professionals",
