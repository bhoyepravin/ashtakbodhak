const teenagersData = {
  hero: {
    ...
    description:
      "Empowering the next generation with essential cybersecurity skills for a safer digital future",
  },
  overview: {
  ...
  delivery: {
    ...
    methods: [
      ...
      "Peer-led Workshops",
      "Awareness through campus campaigns",
      "Influencer-led content",
    ],
  },
  curriculum: {
    title: "Gen Z Edition Curriculum",
    modules: [
      {
        number: "01",
        ...
        topics: [
          ...
          "Risks of oversharing personal info",
        ],
      },
      {
        number: "02",
        ...
        topics: [
          ...
          "Cyberbullying and how to respond & report",
        ],
      },
      {
        number: "03",
        ...
        topics: [
          ...
          "Streaming safely on YouTube, Discord, Twitch",
        ],
      },
      {
        number: "04",
      ...
      },
      {
        ...
        topics: [
          ...
          "Securing phones, laptops, and tablets",
        ],
      },
      {
        number: "06",
      ...
      },
      {
        ...
        topics: [
          ...
          "Where to seek help (helplines, trusted adults)",
        ],
      },
    ],
  },
  cta: {
    title: "Ready to Empower Gen Z?",
    description:
      "Bring our comprehensive cybersecurity program to your school, college, or organization",
