const homeMakersData = {
  hero: {
    title: "HOME MAKERS",
    subtitle: "GrihaRaksha",
    description:
      "Empowering home makers with essential cybersecurity skills to protect their families and digital lives",
  },
  overview: {
  ...
  delivery: {
    ...
    methods: [
      "Community cyber awareness sessions (online / offline)",
    ...
    modules: [
      {
        ...
        topics: [
          ...
          "Real-life examples of fraud and scams targeting homemakers",
        ],
      },
      {
        number: "02",
        ...
        topics: [
          ...
          "QR code safety and avoiding fraudulent payment requests",
        ],
      },
      {
        number: "03",
        ...
        topics: [
          ...
          "Spotting misinformation and emotional manipulation",
        ],
      },
      {
        number: "04",
        ...
        topics: [
          ...
          "Teaching children basic cyber hygiene",
        ],
      },
      {
        number: "05",
        ...
        topics: [
          ...
          "Legal implications of forwarding harmful content",
        ],
      },
      {
        number: "06",
  ...
  cta: {
    title: "Secure Your Home Digital Life",
    description:
      "Join our GrihaRaksha program and become the cybersecurity guardian of your family",
    button: "Enroll Now",
  },
};

export default homeMakersData;
